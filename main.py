...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if '/start' in text:
        ...
        reply += '<a href="https://t.me/+FTRBN-oxzgNkYTEx">Grupo de ayuda 📣 </a>\n'
    ...
    if '/up' in text:
        ...
        try:
            await bot.edit_message(ev.chat,message,text=f'⚙️Generando Session...')
            ...
            await bot.send_file(ev.chat,txtsendname,
                                ...
                                thumb='thumb.png',
                                buttons=[Button.url('👉 Desencriptar','https://t.me/Xdlinkdecrypt_bot')])
